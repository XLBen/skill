...
validator. Before finalizing, apply the `brief-final` questions directly; for a
Guarded/Audited brief load the `pua` skill and run the `brief-final` acceptance
check against the user confirmation and brief evidence, and dispatch a fresh
