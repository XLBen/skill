...
when an SI is being prepared. Reviewer and verdict protocols are needed only
when issues exist.
...
- Test author (测试作者): independently turns the frozen slice scenarios into
  runnable acceptance tests, proves the red result, and freezes the test file
