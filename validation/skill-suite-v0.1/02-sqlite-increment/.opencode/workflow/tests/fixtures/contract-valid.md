    ...
    "V": [
      {
        ...
        "observation": "",
        "given": "The checkout contains scripts/check.py and the selftest uses only temporary files outside the product tree",
        "when": "Run python scripts/check.py --selftest",
        "then": "stdout contains 'selftest PASS' and contains no line beginning with 'selftest FAIL'",
        "assertion_kind": "content",
        "empty_result_policy": "Missing output, empty output, or exit 0 without the literal selftest PASS line is failure",
        "expected": "exit 0 plus stdout contains selftest PASS and no selftest FAIL"
      }
    ],
    "B": [
      {
