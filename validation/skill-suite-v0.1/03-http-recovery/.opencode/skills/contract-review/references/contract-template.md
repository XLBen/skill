...
For a new v0.1 `light`/`full` contract, add a `delivery` object to the JSON
...
- `workflow_protocol` is `v0.1` for a new project and is omitted for a legacy
